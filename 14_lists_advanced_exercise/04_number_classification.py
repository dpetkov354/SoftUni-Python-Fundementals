...
positive_list = [x for x in int_list if int(x) >= 0]
negative_list = [x for x in int_list if int(x) < 0]
even_list = [x for x in int_list if int(x) % 2 == 0]
odd_list = [x for x in int_list if int(x) % 2 != 0]
